; Listing generated by Microsoft (R) Optimizing Compiler Version 15.00.21022.08 
	...
	TITLE	e:\Program\c#\SharpDevelop5\src\AddIns\Analysis\Profiler\Hook\SharedMemory.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; 24   : 	this->fileHandle = OpenFileMapping(FILE_MAP_ALL_ACCESS, false, name);
...
; 25   : 	if (fileHandle == nullptr) {
; 26   : 		DebugWriteLine(L"OpenFileMapping returned nullptr");
; 27   : 	}
; 28   : 	this->startPtr = MapViewOfFile(this->fileHandle, FILE_MAP_ALL_ACCESS, 0, 0, sizeof(SharedMemoryHeader));
...
; 30   : 		DebugWriteLine(L"MapViewOfFile returned nullptr");
; 31   : 		MessageBox(nullptr, TEXT("Could not open Shared Memory, please restart the profiler!"), TEXT("Profiler Error"), MB_OK);
...
; 32   : 	}
; 33   : 	SharedMemoryHeader *header = (SharedMemoryHeader*)this->startPtr;

	mov	edi, DWORD PTR [esi+8]

; 34   : 	#ifdef DEBUG
; 35   : 	if (header->Magic != '~DBG') {
; 36   : 		DebugWriteLine(L"Corrupted shared memory header");
; 37   : 		if (header->Magic == '~SM1') {
; 38   : 			MessageBox(nullptr, TEXT("Wrong build configuration; DEBUG needed!"), TEXT("Profiler Error"), MB_OK);
; 39   : 		}
; 40   : 	}
; 41   : 	#else
; 42   : 	if (header->Magic != '~SM1') {

	mov	eax, DWORD PTR [edi]
	cmp	eax, 2119388465				; 7e534d31H
	je	SHORT $LN2@CSharedMem

; 43   : 		DebugWriteLine(L"Corrupted shared memory header");
; 44   : 		if (header->Magic == '~DBG') {

	cmp	eax, 2118402631				; 7e444247H
	jne	SHORT $LN2@CSharedMem

; 45   : 			MessageBox(nullptr, TEXT("Wrong build configuration; RELEASE needed!"), TEXT("Profiler Error"), MB_OK);
...
; 47   : 	}
; 48   : 	#endif
; 49   : 	this->length = header->TotalLength;
; 50   : 	UnmapViewOfFile(this->startPtr);
...
; 51   : 	DebugWriteLine(L"Length: %d", this->length);
; 52   : 	this->startPtr = MapViewOfFile(this->fileHandle, FILE_MAP_ALL_ACCESS, 0, 0, this->length);
...
; 53   : 	if (startPtr == nullptr) {

	test	eax, eax
	jne	SHORT $LN1@CSharedMem

; 54   : 		char buffer[512];
; 55   : 		sprintf_s(buffer, 512, "Error while creating temporary storage file (shared memory)!\n\nError: %d", GetLastError());

	call	DWORD PTR __imp__GetLastError@0
	push	eax
	push	OFFSET ??_C@_0EI@IBFBEDOB@Error?5while?5creating?5temporary?5s@
	lea	edx, DWORD PTR _buffer$86477[esp+532]
	push	512					; 00000200H
	push	edx
	call	DWORD PTR __imp__sprintf_s
	add	esp, 16					; 00000010H

; 56   : 		DebugWriteLine(L"second MapViewOfFile returned nullptr");
; 57   : 		MessageBox(nullptr, buffer, TEXT("Profiler Error"), MB_OK);

	push	0
	push	OFFSET ??_C@_0P@NHBFFJJG@Profiler?5Error?$AA@
	lea	eax, DWORD PTR _buffer$86477[esp+532]
	push	eax
	push	0
	call	ebp
$LN1@CSharedMem:
...
; 58   : 	}
; 59   : 	this->header = (SharedMemoryHeader*)this->startPtr;
